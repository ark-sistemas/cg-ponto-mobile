...
import senai.fatesg.com.cgponto.recognition.TinyDB;
...
//                flipCameraAnimation();
        ...
        mOpenCvCameraView.setOnTouchListener((v, event) -> mGestureDetector.onTouchEvent(event));
    }
